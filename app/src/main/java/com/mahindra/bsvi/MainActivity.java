            ...
            public void onPageFinished(WebView view, String url) {
                ...
                view.evaluateJavascript(
                        "(function(){window.__mahindraNormalizeResponse=function(raw){"
                                ...
                                + "function b64(v){try{"
                                + "var s=v.replace(/-/g,'+').replace(/_/g,'/');while(s.length%4)s+='=';"
                                ...
                                + "if(p>=0){var q=v.indexOf('content=\"',p);if(q>=0){var z=v.indexOf('\"',q+9);if(z>q)return v.slice(q+9,z);}}"
                                + "p=v.indexOf('content=\"');if(p>=0){var z=v.indexOf('\"',p+9);if(z>p)return v.slice(p+9,z);}"
                                + "return null;"
                                + "}"
                                + "function extract(v){"
                                ...
                                + "var j=parse(t);if(j)return j;var a=t.indexOf('{'),z=t.lastIndexOf('}');"
                                + "if(a>=0&&z>a){j=parse(t.slice(a,z+1));if(j)return j;}"
                                + "a=v.indexOf('{');z=v.lastIndexOf('}');if(a>=0&&z>a){j=parse(v.slice(a,z+1));if(j)return j;}"
                                + "return null;"
                                + "}"
                                + "try{var o=(typeof raw==='string')?JSON.parse(raw):raw;var b=o&&o.body;var j=extract(typeof b==='string'?b:'');"
                                ...
                                + "}catch(e){var err={ok:false,code:0,error:'Backend response error: '+(e.message||e),details:String(raw).slice(0,1200)};"
