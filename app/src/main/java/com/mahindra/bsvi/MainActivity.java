    ...
    private void configureWebView() {
        ...
        web.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                // The WebView shell owns the complete login UI. Do not create a second
                // native login overlay; that overlay previously caused the wrong dashboard
                // and made the mobile/password fields appear unreliable.
                view.evaluateJavascript(
                        "(function(){try{localStorage.removeItem('mahindra_secure_token_v1');localStorage.removeItem('mahindra_secure_user_v1');localStorage.removeItem('mahindra_user_role_v2');}catch(e){};var s=document.createElement('script');s.src='file:///android_asset/app_shell.js';s.onload=function(){var f=document.createElement('script');f.src='file:///android_asset/startup_fix.js';document.head.appendChild(f);};document.head.appendChild(s);})();",
                        null
                );
            }
