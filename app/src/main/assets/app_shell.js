...
dpf:[['1️⃣','Park in a safe open area.','Safety condition'],['2️⃣','Apply hand brake and use wheel chokes.','Safety condition'],['3️⃣','Keep the vehicle in neutral.','Transmission condition'],['4️⃣','PTO must be disengaged.','PTO condition'],['5️⃣','Exhaust brake must be OFF.','Exhaust brake condition'],['6️⃣','Do not operate the accelerator.','Driver control'],['7️⃣','Inhibit switch must be OFF.','Switch condition'],['8️⃣','Press the DPF regeneration switch for about 5 seconds and release.','Regeneration switch']],
...
adblue:[['🧼','Keep the filler area clean.','Filling precaution'],['🚫','Prevent dust or mud contamination.','Contamination prevention'],['⛽','Use the dedicated filling arrangement.','Correct filling'],['💧','Do not put anything other than AdBlue into the AdBlue tank.','Correct fluid'],['⚠️','Do not overfill.','Filling precaution'],['🛠️','If a warning or fault remains, contact authorized service.','Service action']],
safety:[['📵','Do not use a mobile phone while driving.','Safe driving'],['🦺','Wear the seat belt.','Occupant safety'],['🚦','Follow traffic rules and speed limits.','Road safety'],['😴','Do not drive when tired.','Driver condition'],['↔️','Maintain a safe distance.','Following distance'],['🔍','Inspect the vehicle before driving.','Vehicle check'],['🛠️','Repair work should be carried out by authorized persons.','Repair safety']]};
