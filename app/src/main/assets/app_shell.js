  ...
  function driverGuide(type){
    ...
    const html=items.map((x,i)=>{
      ...
      return '<div class="ma-guide-item">'+
        '<div class="ma-truck-icon">'+esc(x[0])+'</div>'+
